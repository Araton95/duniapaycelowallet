...
contract BaseModule is Module {
    ...
    modifier onlyWalletOwner(BaseWallet _wallet) {
        require(
            msg.sender == address(this) || isOwner(_wallet, msg.sender),
    ...
    modifier strictOnlyWalletOwner(BaseWallet _wallet) {
        require(
            ...
            "BM: msg.sender must be an owner for the wallet"
        );
        _;
    }
     ...
     */
    function addModule(BaseWallet _wallet, Module _module)
        external
     ...
     */
    function isOwner(BaseWallet _wallet, address _addr)
        internal
        view
        returns (bool)
    {
