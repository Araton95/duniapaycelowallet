...
contract LegacyTokenTransfer is BaseModule, RelayerModule, LimitManager {
    ...
    /**
    * @dev lets the owner transfer tokens (CGold or Ccfa) from a wallet.
    ...
    */
     ...
     * The limit is expressed in CGold. Changes to the limit take 24 hours.
     * @param _wallet The target wallet.
    ...
    */
    ...
    /**
    * @dev Helper method to transfer CGold for a wallet.
    * @param _wallet The target wallet.
